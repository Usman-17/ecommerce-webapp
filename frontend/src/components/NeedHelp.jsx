...
const NeedHelp = () => (
  <Motion.div
    ...
    className=" hidden lg:block lg:w-72 shrink-0 rounded-xl border border-red-100/80 overflow-hidden text-center"
    style={{
  ...
  >
    ...
    <div className="px-5 pt-3 pb-5">
      ...
      <Link
        to="/contact-us"
        className="inline-flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-xl text-white text-sm font-semibold transition-all duration-150 hover:opacity-90 active:scale-95"
