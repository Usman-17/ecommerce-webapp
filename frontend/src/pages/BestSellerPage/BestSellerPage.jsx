...
import bestSellerBanner from "../../assets/best-seller.webp";
...
const BestSellerPage = () => {
  ...
  return (
    <div className="min-h-screen -mt-1.5 sm:mt-0 pb-10 sm:pb-4 sm:py-3 sm:px-[4vw]">
      <SEO
        title="Best Sellers"
        description="Shop our most popular jewelry, makeup & beauty products, and hair accessories. See what other customers love at Jemzy."
        keywords="best sellers, popular jewelry, trending makeup, top hair accessories"
        url="/best-sellers"
      />
              ...
              {sortedProducts.length === 0 ? (
                <div className="col-span-full flex flex-col items-center justify-center py-8">
                  ...
                  <p className="mt-4 text-center text-gray-500 text-sm">
                    We couldn&apos;t find any best sellers. Check back later!
                  </p>
                </div>
              ) : (
                <div
