...
const JewelrySection = () => {
  ...
  useEffect(() => {
    if (scrollRef.current && jewelryProducts.length > 0) {
  ...
  if (jewelryProducts.length === 0) return null;
    ...
    <section className="pt-8 pb-16 sm:pt-12 sm:pb-6 lg:px-32">
      <div className="max-w-480 mx-auto">
        <SectionHeader
          ...
          description="Shop stunning jewelry designed to add charm, confidence, and timeless beauty to your look."
          viewAllLink="/shop?area=Jewelry"
        />
